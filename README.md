...
I'm a passionate **Software Engineer** and **Full Stack Developer** with expertise in modern web technologies. I love creating innovative solutions and building applications that make a difference. Currently focused on developing cutting-edge web applications and mobile solutions.

- 🔭 I'm currently working on **AI-powered applications** and **modern web solutions**
- 🌱 I'm constantly learning **new technologies** and **best practices**
- 👯 I'm looking to collaborate on **open source projects**
- 💬 Ask me about **React**, **TypeScript**, **Astro**, **React Native**
- 📫 How to reach me: **jfelipe9.121@gmail.com**

---

<!-- APIs de actividad en GitHub -->
<div align="center">
  <img width="49%" height="195px" src="https://github-readme-stats.vercel.app/api/?username=felipesanchez-dev&show_icons=true&theme=onedark" />
  <img width="49%" height="195px" src="https://github-readme-stats.vercel.app/api/top-langs/?username=felipesanchez-dev&layout=compact&theme=onedark" />
</div>
...
[<img height="48px" width="48px" alt="Vue.js" src="https://skillicons.dev/icons?i=vue"/>](https://vuejs.org/)
[<img height="48px" width="48px" alt="Astro" src="https://skillicons.dev/icons?i=astro"/>](https://astro.build/)

### 📱 Mobile Development:
[<img height="48px" width="48px" alt="React Native" src="https://skillicons.dev/icons?i=react"/>](https://reactnative.dev/)
[<img height="48px" width="48px" alt="Android" src="https://skillicons.dev/icons?i=androidstudio"/>](https://developer.android.com/)
...
[<img height="48px" width="48px" alt="Tailwind CSS" src="https://skillicons.dev/icons?i=tailwindcss"/>](https://tailwindcss.com/)
...
[<img height="48px" width="48px" alt="PostgreSQL" src="https://skillicons.dev/icons?i=postgresql"/>](https://www.postgresql.org/)
[<img height="48px" width="48px" alt="MongoDB" src="https://skillicons.dev/icons?i=mongodb"/>](https://www.mongodb.com/)
[<img height="48px" width="48px" alt="Firebase" src="https://skillicons.dev/icons?i=firebase"/>](https://firebase.google.com/)

### ⚙️ Backend & Server:
[<img height="48px" width="48px" alt="Node.js" src="https://skillicons.dev/icons?i=nodejs"/>](https://nodejs.org/en)
[<img height="48px" width="48px" alt="TypeScript" src="https://skillicons.dev/icons?i=ts"/>](https://www.typescriptlang.org/)
[<img height="48px" width="48px" alt="Express.js" src="https://skillicons.dev/icons?i=express"/>](https://expressjs.com/)
[<img height="48px" width="48px" alt="Postman" src="https://skillicons.dev/icons?i=postman"/>](https://www.postman.com/)
[<img height="48px" width="48px" alt="NPM" src="https://skillicons.dev/icons?i=npm"/>](https://www.npmjs.com/)
[<img height="48px" width="48px" alt="API" src="https://skillicons.dev/icons?i=fastapi"/>](https://fastapi.tiangolo.com/)

### 🔧 Tools & Software:
[<img height="48px" width="48px" alt="VS Code" src="https://skillicons.dev/icons?i=vscode"/>](https://code.visualstudio.com/)
[<img height="48px" width="48px" alt="Visual Studio" src="https://skillicons.dev/icons?i=visualstudio"/>](https://visualstudio.microsoft.com)
...
### 🤖 [Agentesia - AI Agents Platform](https://github.com/felipesanchez-dev/agentesia)
**Tech Stack:** `Next.js` `TypeScript` `AI Integration`
- Innovative AI-powered application platform
- Modern user interface with advanced functionality
- Real-time AI agent interactions

### 🌐 [Professional Portfolio](https://felipesanchezdev.site)
**Tech Stack:** `Astro` `TypeScript` `Modern Design`
...
`Agile Methodologies` `Requirements Engineering` `Software Architecture` `Professional Ethics` `Project Management` `Software Development` `Software Security` `Software Quality` `DevOps` `CI/CD`

### 💻 Full Stack Development
`React.js` `Next.js` `React Native` `Angular` `Vue.js` `Astro` `TypeScript` `JavaScript` `Node.js` `Express.js` `RESTful APIs` `HTML5` `CSS3` `SASS` `Tailwind CSS` `Bootstrap` `MySQL` `PostgreSQL` `MongoDB` `Firebase` `Git` `GitHub` `Postman` `NPM` `Responsive Design` `API Development`

### 🤖 Emerging Technologies
`Artificial Intelligence` `Machine Learning` `API Integration` `Mobile Development` `Progressive Web Apps` `Cloud Services` `Modern Web Frameworks`
...
<div align="center">
  <img width="70%" src="https://github-readme-activity-graph.vercel.app/graph?username=felipesanchez-dev&theme=react-dark&bg_color=0d1117&color=5BCDEC&line=5BCDEC&point=FFFFFF&area=true&hide_border=true" />
</div>
...
[<img height="48px" width="48px" alt="LinkedIn" src="https://skillicons.dev/icons?i=linkedin"/>](https://www.linkedin.com/in/felipereyessa/)
[<img height="48px" width="48px" alt="Instagram" src="https://skillicons.dev/icons?i=instagram"/>](https://www.instagram.com/felipesanchez_dev/)
[<img height="48px" width="48px" alt="Gmail" src="https://skillicons.dev/icons?i=gmail"/>](mailto:jfelipe9.121@gmail.com)

**📧 Email:** jfelipe9.121@gmail.com  
**🌐 Portfolio:** [felipesanchezdev.site](https://felipesanchezdev.site)  
**📱 Mobile Apps:** Available for download on my repositories  
...
- 🎯 I've built mobile games available as APK downloads
- 🌱 Currently working on AI-powered applications
- 🏗️ I create complete business solutions from scratch
- 📚 Always learning and adapting to new technologies
- 🎨 I combine functionality with beautiful design
